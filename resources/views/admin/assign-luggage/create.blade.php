                ...
                <div class="card stretch stretch-full">
                    ...
                    <div class="card-body">
                        <form id="luggage-assign-form" action="{{ route('assign-luggage.save') }}" method="POST" enctype="multipart/form-data" data-index-url="{{ route('assign-luggage.index') }}">
                                ...
                                <div class="{{ $isDriver ? 'col-md-3' : 'col-md-4' }} mb-3">
                                    ...
                                    <select name="company_id" id="company_id" class="form-control @error('company_id') is-invalid @enderror" required>
                                        ...
                                        @foreach($companies as $company)
                                            <option value="{{ $company->id }}" {{ old('company_id') == $company->id ? 'selected' : '' }} @if(($indigoCompanyId ?? null) == $company->id) data-indigo="1" @endif>
                            ...
                            @include('admin.assign-luggage._indigo-panel', ['assignment' => null])
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="datetime-local" name="expected_delivery_date" id="expected_delivery_date" class="form-control @error('expected_delivery_date') is-invalid @enderror" value="{{ old('expected_delivery_date') }}" required>
