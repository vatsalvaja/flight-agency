        ...
        <tr>
            <td align="center">
                <table class="container" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #ffffff; border-radius: 16px; box-shadow: 0 10px 25px rgba(0, 0, 0, 0.03); overflow: hidden; border: 1px solid #e2e8f0;">
                    ...
                    <tr>
                        <td align="center" style="background: linear-gradient(135deg, #1e293b 0%, #0f172a 100%); padding: 35px 40px; color: #ffffff;">
                            @if(isset($appSettings->application_logo) && !empty($appSettings->application_logo))
                                <img src="{{ url($appSettings->application_logo) }}" alt="{{ $appSettings->application_name }}" style="max-height: 55px; margin-bottom: 12px; display: block;">
                            @endif
                            <h1 style="margin: 0; font-size: 24px; font-weight: 700; letter-spacing: -0.5px; color: #ffffff;">{{ $appSettings->application_name ?? 'Wings & Wheels' }}</h1>
                            <p style="margin: 5px 0 0 0; font-size: 13px; color: #94a3b8; font-weight: 500; text-transform: uppercase; letter-spacing: 1px;">Logistics Management</p>
                        </td>
                    </tr>
